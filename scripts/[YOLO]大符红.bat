...
set "PARAM=%ROOT%\examples\example_for_prediction\7_dark_red_big\parameter.yaml"
...
"%EXE%" --python-root "%ROOT%" --parameter "%PARAM%" --mode big --color red --detector yolo --onnx "%ONNX%"

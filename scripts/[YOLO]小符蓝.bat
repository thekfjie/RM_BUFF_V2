...
set "PARAM=%ROOT%\examples\example_for_prediction\8_dark_blue_small\parameter.yaml"
...
"%EXE%" --python-root "%ROOT%" --parameter "%PARAM%" --mode small --color blue --detector yolo --onnx "%ONNX%"
...
echo Please train a model first and place best.onnx in models/
pause
exit /b 1

...
#include <rm_buff_tracker/msg/buff_target.hpp>
...
private:
    ...
    void publishBuffTarget(const std_msgs::msg::Header& header,
    ...
    rclcpp::Publisher<rm_buff_tracker::msg::BuffTarget>::SharedPtr targetPub_;
